...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UserResponse', user?: { __typename?: 'User', _id: number, username: string } | null, errors?: Array<{ __typename?: 'FieldError', message: string, field: string }> | null } };
